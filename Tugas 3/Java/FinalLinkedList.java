public class FinalLinkedList {
    ...
    public static FinalLinkedList insert(FinalLinkedList list,
                                    int data)
    {
    ...
    public static void printList(FinalLinkedList list)
    {
    ...
    public static FinalLinkedList deleteByKey(FinalLinkedList list,
                                         int key)
    {
        // Store head node
    ...
    public static FinalLinkedList
    deleteAtPosition(FinalLinkedList list, int index)
    {
        // Store head node
        Node currNode = list.head, prev = null;
